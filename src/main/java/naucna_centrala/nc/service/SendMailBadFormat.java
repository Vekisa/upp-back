...
public class SendMailBadFormat implements JavaDelegate {
    @Autowired
    ...
    public void execute(DelegateExecution delegateExecution) throws Exception {
        ...
        emailSender.send(cu.getEmail(), "Nije ti rad dobro formatiran!");
        delegateExecution.setVariable("odobravan",true);
    }
}
